...
namespace Com.Lmax.Api.OrderBook
{
    ...
    public class CommercialInfo
    {
        ...
        private readonly decimal _fundingRate;
        ...
        public CommercialInfo(decimal minimumCommission, decimal? aggressiveCommissionRate, decimal? passiveCommissionRate,
                              ...
                              string fundingBaseRate, int dailyInterestRateBasis, decimal fundingRate)
        {
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                result = (result*397) ^ _fundingRate.GetHashCode();
                return result;
            }
        }
        ...
        public override string ToString()
        {
            return string.Format("MinimumCommission: {0}, AggressiveCommissionRate: {1}, PassiveCommissionRate: {2}, AggressiveCommissionPerContract: {3}, PassiveCommissionPerContract: {4}, FundingBaseRate: {5}, DailyInterestRateBasis: {6}, FundingRate: {7}", 
                _minimumCommission, _aggressiveCommissionRate, _passiveCommissionRate, _aggressiveCommissionPerContract, _passiveCommissionPerContract, _fundingBaseRate, _dailyInterestRateBasis, _fundingRate);
        }
    }
}
