...
namespace Com.Lmax.Api
{
    ...
    public delegate void OnInstructionResponse(long instructionId);
    ...
    public delegate void OnHistoricMarketDataEvent(long instructionId, List<Uri> uris);
    ...
    /// Empty if there is no data available for the requested date range.</param>
    public delegate void OnMarketDataEvent(long instructionId, List<Uri> uris);
    ...
    public class LmaxApi
    {
        ...
        /// For testing: 'https://testapi.lmaxtrader.com' and production: 'https://trade.lmaxtrader.com'.
        /// </summary>
        /// <param name="urlBase">
