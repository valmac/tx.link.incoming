namespace Com.Lmax.Api.Order
{
    ...
    public class MarketOrderSpecification : OrderSpecification
    {
        ...
        public MarketOrderSpecification(long instructionId, long instrumentId, decimal quantity, TimeInForce timeInForce, decimal? stopLossPriceOffset, decimal? stopProfitPriceOffset) :
        ...
        /// <param name="timeInForce">A <see cref="TimeInForce"/> that describes the behaviour of the order
        /// if not fully filled</param>
        public MarketOrderSpecification(long instructionId, long instrumentId, decimal quantity, TimeInForce timeInForce) :
