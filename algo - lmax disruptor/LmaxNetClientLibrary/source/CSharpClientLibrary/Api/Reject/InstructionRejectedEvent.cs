...
namespace Com.Lmax.Api.Reject
{
    ...
    public class InstructionRejectedEvent : IEquatable<InstructionRejectedEvent>
    {
        ...
        public InstructionRejectedEvent(long instructionId, long accountId, long instrumentId, string reason)
        {
        ...
        {
            return string.Format("InstructionId: {0}, AccountId: {1}, InstrumentId: {2}, Reason: {3}", _instructionId, _accountId, _instrumentId, _reason);
        }
